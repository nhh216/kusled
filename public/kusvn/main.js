...
/*----------------------------------------*/
	...
	function makeTimer($endDate, $this, $format) {
		...
		var yearsLeft = yearsLeft < 10 ? "0" + yearsLeft : yearsLeft,
			...
			yearsText = yearsLeft > 1 ? 'năm' : 'năm',
			monthsText = monthsLeft > 1 ? 'tháng' : 'tháng',
			weeksText = weeksLeft > 1 ? 'tuần' : 'tuần',
			daysText = daysLeft > 1 ? 'ngày' : 'ngày',
			hourText = hrsLeft > 1 ? 'giờ' : 'giờ',
			minsText = minsLeft > 1 ? 'phút' : 'phút',
			secText = secsLeft > 1 ? 'giây' : 'giây';
