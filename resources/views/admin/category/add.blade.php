                    ...
                    <div class="col-md-12">
                        <div class="card card-success">
                            <div class="card-header">
                                ...
                                <button class="btn btn-light btn-card-header">Thêm mới</button>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputRounded0">Tên <code>*</code></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputRounded0">Loại <code>*</code></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputRounded0">Ảnh <code></code></label>
